              ...
              <div className="service-item bg-light rounded w-150" style={{ width: "350px" }}>
                ...
                <div className="service-content text-center p-4">
                  <div className="service-content-inner ms-3">
                    <span className="ms-1" style={{color:"black"}}>Name:{dev?.userId?.name || "N/A"}</span>
                    <br/>
                    <span className="ms-1" style={{color:"black"}}>Email:{dev?.userId?.email || "N/A"}</span>
                    <br/>
                    <span className="ms-1" style={{color:"black"}}>Contact:{dev.contact || "N/A"}</span>
                    <br/>
                    <span className="ms-1" style={{color:"black"}}>Technologies:{dev?.technologyId?.map((ele,index)=>{
                        return(
                            <>
                        <span style={{marginRight:"8px",color:"black"}}>{ele.name}</span>
