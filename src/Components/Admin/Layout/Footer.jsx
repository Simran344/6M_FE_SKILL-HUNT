          ...
          <div className="row g-5 ">
            <div className="col-md-6 col-lg-6 col-xl-3">
              <div className="footer-item d-flex flex-row ms-5">
                ...
                <Link to="/admin/user" className="me-5" style={{ marginLeft: "55px" }}>
                   Client
                </Link>
                <Link to="/admin/dev" className="me-5" style={{ marginLeft: "55px" }}>
                  Developer
                </Link>
                <Link to="/admin/project" className="me-5" style={{ marginLeft: "55px" }}>
                  Project
                </Link>
                <Link to="/admin/bid" className="me-5" style={{ marginLeft: "55px" }}>
                  Bidding
                </Link>
               
                <Link to="/admin/add" className="me-5" style={{ marginLeft: "55px" }}>
                  Add and Manage Technology
                </Link>
